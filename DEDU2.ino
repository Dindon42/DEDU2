...
//float MaChanson[3][100];
  ...
  const PROGMEM float WhatIsLove[3][13] = {
    {311,369,415,311,329,311,369,311,311,369,311,311,277},
    {80.1,128.6,842.2,132.8,146.5,151.8,331,874.9,132.8,344.7,858,151.8,1375.6},
    {95.1,109.5,349.5,105.3,90.3,86.3,145.2,316.8,105.3,130.3,332.5,86.3,425},
    };
////
